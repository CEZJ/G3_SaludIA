...
// ¡Importante! Asegúrate de importar NgOptimizedImage
...
export class InicioComponent implements OnInit {
  ...
  //
  // ¡LISTA DEL EQUIPO ACTUALIZADA!
  //
  teamList = [
    {
      name: 'Cristina Allison Sihuas Diaz',
      role: 'Estudiante de Ingeniera de Sistemas de Informacion',
      img: 'assets/members/Cristina.jpeg',
      description: 'Especialista en arquitectura de software y backend. Lidera el desarrollo de nuestra IA de diagnóstico.',
      linkedinUrl: 'https://www.linkedin.com/in/cristina-sihuas' // (URL de ejemplo)
    },
    {
      name: 'Franck Panduro ',
      role: 'Estudiante de Ingeniera de Sistemas de Informacion',
      img: 'assets/members/Franck.jpeg',
      description: 'Experto en DevOps y seguridad en la nube. Garantiza que la plataforma sea escalable y segura.',
      linkedinUrl: 'https://www.linkedin.com/in/franck-placeholder' // (URL de ejemplo)
    },
    {
      name: 'Carlos Enrique Zegarra Jurado',
      role: 'Estudiante de Ingeniera de Sistemas de Informacion',
      img: 'assets/members/Carlos.jpeg',
      description: 'Desarrollador Frontend enfocado en la experiencia de usuario (UX) y la accesibilidad.',
      linkedinUrl: 'https://www.linkedin.com/in/carlosenrique-placeholder' // (URL de ejemplo)
    },
    {
      name: 'Miguel Salas',
      role: 'Estudiante de Ingeniera de Sistemas de Informacion',
      img: 'assets/members/Miguel.jpeg',
      description: 'Analista de datos y machine learning. Entrena los modelos que potencian nuestros diagnósticos.',
      linkedinUrl: 'https://www.linkedin.com/in/miguel-placeholder' // (URL de ejemplo)
    },
    {
      name: 'Antuaneth Angie Angulo Altamirano',
      role: 'Estudiante de Ingeniera de Sistemas de Informacion',
      img: 'assets/members/Antuaneth.jpeg',
      description: 'Gestora de proyectos (PM) y QA. Se asegura de que cada entrega cumpla con los más altos estándares.',
      linkedinUrl: 'https://www.linkedin.com/in/antu-placeholder' // (URL de ejemplo)
    }
  ];
